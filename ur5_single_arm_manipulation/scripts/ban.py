...
if __name__ == '__main__':
    ...
    gold_block_pose = Pose(position=Point(x=0.6, y=0.01, z=0.44+0.03))
    dropbox_path = pack_path+os.sep+'urdf'+os.sep+'objects'+os.sep+'zhuozi.urdf'
    dropbox_name = 'dropbox'
    dropbox_pose = Pose(position=Point(x=0.6, y=-0.0, z=0.3705+0.03))
