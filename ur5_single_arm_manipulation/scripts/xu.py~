...
if __name__ == '__main__':
    ...
    gold_block_pose = Pose(position=Point(x=0.6, y=0.01, z=0.4355+0.03))
    dropbox_path = pack_path+os.sep+'urdf'+os.sep+'objects'+os.sep+'table2.urdf'
    dropbox_name = 'dropbox'
    dropbox_pose = Pose(position=Point(x=0.6, y=-0.0, z=0.4105+0.03))
    
    white_block_path = pack_path+os.sep+'urdf'+os.sep+'objects'+os.sep+'white_block.urdf'
    white_block_name = 'white_block'
    white_block_pose = Pose(position=Point(x=0.5, y=-0.0, z=0.4405+0.03))
    
    green_block_path = pack_path+os.sep+'urdf'+os.sep+'objects'+os.sep+'green_block.urdf'
    green_block_name = 'green_block'
    green_block_pose = Pose(position=Point(x=0.7, y=0.0, z=0.44+0.03))
    
    orange_block_path = pack_path+os.sep+'urdf'+os.sep+'objects'+os.sep+'orange_block.urdf'
    orange_block_name = 'orange_block'
    orange_block_pose = Pose(position=Point(x=0.6, y=-0.11, z=0.44+0.03))
    
    indigo_block_path = pack_path+os.sep+'urdf'+os.sep+'objects'+os.sep+'indigo_block.urdf'
    indigo_block_name = 'indigo_block'
    indigo_block_pose = Pose(position=Point(x=0.5, y=-0.1, z=0.44+0.03))
    
    bricks_block_path = pack_path+os.sep+'urdf'+os.sep+'objects'+os.sep+'bricks_block.urdf'
    bricks_block_name = 'bricks_block'
    bricks_block_pose = Pose(position=Point(x=0.7, y=-0.1, z=0.44+0.03))
    
    delete_gazebo_model([dropbox_name,white_block_name,gold_block_name,green_block_name,orange_block_name,indigo_block_name,bricks_block_name])
    
    spawn_gazebo_model(dropbox_path, dropbox_name, dropbox_pose,)
